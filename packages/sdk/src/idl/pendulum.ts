export type Pendulum = {
    ...
    },
    {
      ...
      accounts: [
        ...
        },
        {
          ...
          isMut: false;
          isSigner: false;
          docs: ["~SQUADS-PROTOCOL-CPI-ACCOUNTS~", ""];
        },
        {
          name: "multisigVault";
          isMut: false;
  ...
  accounts: [
    {
      name: "offering";
      docs: ["Represents the acquisition round for some instrument."];
      type: {
        kind: "struct";
        fields: [
          {
          ...
          {
            name: "initialShares";
            docs: ["The number of shares offered at creation."];
            type: "u16";
          },
          {
            name: "boughtShares";
            docs: ["The number of shares already purchased."];
            type: "u16";
          },
          {
            name: "buyIns";
          ...
          {
            name: "paymentMint";
            docs: ["The token used for payment."];
            type: "publicKey";
          },
          {
            name: "paymentsTokenAccount";
          ...
          {
            name: "pricePerShare";
            docs: ["The cost(token amount) of a single share."];
            type: "u64";
          },
          {
            name: "state";
            docs: ["The state of this offering."];
            type: {
          ...
          {
            name: "nftUri";
            docs: ["The uri for purchase nfts."];
            type: "string";
          }
        ];
      };
    },
    {
      ...
      type: {
        ...
        fields: [
          ...
          {
            name: "multisig";
            docs: ["The squads multisig."];
            type: "publicKey";
          },
          {
            name: "multisigVaultIndex";
            docs: ["The index of the multisig vault."];
            type: "u8";
          },
          {
            name: "clockworkThread";
            docs: ["The clockwork-thread that starts proposals."];
            type: "publicKey";
          },
          {
            name: "offering";
            docs: ["The offering this distribution is for."];
            type: "publicKey";
          },
          {
            name: "tokenMint";
            docs: ["The mint of tokens being received and distributed."];
            type: "publicKey";
          },
          {
            name: "frequencyInSeconds";
            docs: ["How frequently(in seconds) payment should be distributed."];
            type: "u64";
          },
          {
            name: "roundIndex";
    ...
    {
      name: "buyIn";
      docs: ["Represents ownership of the shares in an [Offering]."];
      type: {
        kind: "struct";
        fields: [
          {
            name: "offering";
            docs: ["The offering bought from."];
            type: "publicKey";
          },
          {
            name: "index";
          ...
          {
            name: "shares";
            docs: ["The number of shares bought."];
            type: "u16";
          },
          {
            name: "timestamp";
            docs: ["The time this purchase was made."];
            type: "i64";
          },
          {
            name: "beneficiary";
            docs: ["The wallet that's entitled to receive earnings."];
            type: "publicKey";
          },
          {
            name: "tokenMint";
            docs: ["The nft-mint that's proof of tokenized ownership."];
            type: "publicKey";
          }
        ];
      };
  ...
  types: [
    {
      ...
      type: {
        ...
        fields: [
          ...
          {
            name: "proposal";
            docs: ["The multisig proposal this round is dependent on."];
            type: "publicKey";
          },
          {
            name: "endTimestamp";
            docs: ["The timestamp beyond which its okay to start distributing"];
            type: "i64";
          },
          {
            name: "index";
          ...
          {
            name: "distribution";
            docs: ["The distribution this account is derived from."];
            type: "publicKey";
          },
          {
            name: "status";
            docs: ["The status of this distribution round."];
            type: {
              defined: "RoundStatus";
            };
          },
          {
            name: "paidOut";
            docs: ["The amount this round has paid out."];
            type: "u64";
          }
        ];
      };
